...
async def create_profile(
    ...
    try:
        ...
        allergies_encrypted = encrypt_data(profile.allergies or [])
        medications_encrypted = encrypt_data(profile.medications or [])
        conditions_encrypted = encrypt_data(profile.medical_conditions or [])
