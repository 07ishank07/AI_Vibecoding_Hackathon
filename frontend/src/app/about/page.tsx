        ...
        <div className="max-w-5xl mx-auto px-6 py-16">
          ...
          <div className="text-center mb-20">
            ...
            <h1 className="text-5xl font-black text-white mb-6 tracking-tight">
              About Crisis<span className="text-red-500">Link</span><span className="text-slate-400">.cv</span>
            </h1>
          ...
          <div className="grid md:grid-cols-3 gap-8 mb-20">
            <div className="text-center p-8 bg-slate-800/50 backdrop-blur border border-slate-700 rounded-2xl">
              <div className="text-4xl font-black text-red-500 mb-2">250K+</div>
              <div className="text-slate-300 font-medium">Preventable Deaths Annually</div>
            </div>
            <div className="text-center p-8 bg-slate-800/50 backdrop-blur border border-slate-700 rounded-2xl">
              <div className="text-4xl font-black text-green-500 mb-2">3 SEC</div>
              <div className="text-slate-300 font-medium">Average QR Scan Time</div>
            </div>
            <div className="text-center p-8 bg-slate-800/50 backdrop-blur border border-slate-700 rounded-2xl">
              <div className="text-4xl font-black text-blue-500 mb-2">24/7</div>
              <div className="text-slate-300 font-medium">Global Accessibility</div>
            </div>
          </div>
          ...
          <div className="mb-20">
            <div className="bg-gradient-to-r from-red-500 to-red-600 rounded-2xl p-12 text-white">
              ...
              <div className="grid md:grid-cols-2 gap-8">
                ...
                <div className="bg-red-400/20 rounded-xl p-6">
          ...
          {/* Solution */}
          <div className="mb-20">
            <h2 className="text-3xl font-bold text-white text-center mb-12">Our Revolutionary Solution</h2>
            <div className="grid lg:grid-cols-4 gap-6">
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Instant QR Access</h3>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">AI Voice Assistant</h3>
                <p className="text-slate-600 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Auto Notifications</h3>
                <p className="text-slate-600 leading-relaxed">
              ...
              <div className="bg-white rounded-2xl p-8 shadow-sm border border-slate-200 hover:shadow-md transition-shadow">
                ...
                <h3 className="text-xl font-bold text-slate-900 mb-3">Privacy Control</h3>
                <p className="text-slate-600 leading-relaxed">
          ...
          <div className="mb-20">
            <h2 className="text-3xl font-bold text-slate-900 text-center mb-12">Enterprise-Grade Technology</h2>
          ...
          <div className="text-center bg-white rounded-2xl p-12 shadow-sm border border-slate-200">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a 
                href="/create-profile"
                className="bg-red-600 hover:bg-red-700 text-white font-bold py-4 px-8 rounded-xl transition-all duration-200 transform hover:scale-105"
              >
